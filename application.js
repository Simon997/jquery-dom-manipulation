...
function runChallenges() {
  ...
  $("#email").val("sim.boily311@gmail.com");
  ...
  team_count = $('.table tr').size()-1;


  // Ex 6. Say there is a 15th team added to the table.
  //       Add a row at the bottom, this new team should have zero points.
  $('.table tbody').append('<tr><td>15</td><td>15th team </td><td>0</td></tr>')


  // Ex 7. Write some code to sum all points given to all teams
  var sum = 0;  // TODO: replace 0 with your sum result, keep the sum variable.
  $('.table > tbody > tr').each(function(){
    sum = sum+parseInt($(this).find('td:last').text());
  });
